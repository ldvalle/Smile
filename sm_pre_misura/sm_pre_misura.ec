...
/*
	...
	for(iPlan=41; iPlan <= 80; iPlan++){
		...
		rsetnull(CLONGTYPE, (char *) &(lFechaBaja));
				...
				if(regLectura.tipo_lectura == 8){
					if(LeoLecturaPend(lNroCliente, iCorrFacturacion, &regLectuPend)){
						if(regLectuPend.lectura_facturac >= 0){
							GenerarPlanoMisura(regLectuPend, 1, iEstadoCliente, lFechaBaja);
							GenerarPlanoAdjunto(regLectuPend, 1, iEstadoCliente, lFechaBaja);
					...
					GenerarPlanoAdjunto(regLectura, 0, iEstadoCliente, lFechaBaja);
...
short LeoCliente(lNroCliente, lFechaPivote, lFechaMoveIn, iCorrFacturacion, iEstadoCliente, lFBaja)
$long *lNroCliente;
$long *lFechaPivote;
$long *lFechaMoveIn;
$int  *iCorrFacturacion;
